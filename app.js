...
app.get('/road1', function (req, res) {
 ...
 <form id="form1" action="/write" method="get">
 ...
 Cycle:<input id="C2" type="number" value="0" min=0 name="B2" max="20"><br>
...
app.get('/write',urlencodedParser,function(req,res){
 var T1=req.body.T1
 ...
 var C2=req.body.C2
 var B2=req.body.B2
 var space=T1*5+T31*7+T32*7+T21*6+T22*6+T4*2+B1*5+B2*1+C2*1+B1*5+E*2
...
app.get('/road2', function (req, res) {
 ...
 <h2>Road 2</h1>
 <p>Enter the count of vehicles click add to add then into space</p>
 <form action="/append2" method="get">
 Truck:<input id="T1" type="number" value="0" min=0 name="T1" max="5"><br>
 Unloaded Troller:<input id="T31" type="number" value="0" min=0 name="T31" max="5"><br>
 Loaded Troller:<input id="T32" type="number" value="0" min=0 name="T32" max="5"><br>
 Unloaded Tanker:<input id="T21" type="number" value="0" min=0 name="T21" max="5"><br>
 ...
 app.get('/append2',urlencodedParser,function(req,res){
 var T1=req.body.T1
 var T31=req.body.T31
 var T32=req.body.T32
 var T21=req.body.T21
 ...
 <h2>Road 3</h1>
 <p>Enter the count of vehicles click add to add then into space</p>
 <form action="/append3" method="get">
 Truck:<input id="T1" type="number" value="0" min=0 name="T1" max="5"><br>
 Unloaded Troller:<input id="T31" type="number" value="0" min=0 name="T31" max="5"><br>
 Loaded Troller:<input id="T32" type="number" value="0" min=0 name="T32" max="5"><br>
 Unloaded Tanker:<input id="T21" type="number" value="0" min=0 name="T21" max="5"><br>
 ...
 app.get('/append3',urlencodedParser,function(req,res){
 var T1=req.body.T1
 var T31=req.body.T31
 var T32=req.body.T32
 var T21=req.body.T21
 ...
 <h2>Road 4</h1>
 <p>Enter the count of vehicles click add to add then into space</p>
 <form action="/append4" method="get">
 Truck:<input id="T1" type="number" value="0" min=0 name="T1" max="5"><br>
 Unloaded Troller:<input id="T31" type="number" value="0" min=0 name="T31" max="5"><br>
 Loaded Troller:<input id="T32" type="number" value="0" min=0 name="T32" max="5"><br>
 Unloaded Tanker:<input id="T21" type="number" value="0" min=0 name="T21" max="5"><br>
 ...
 app.get('/append4',urlencodedParser,function(req,res){
 var T1=req.body.T1
 var T31=req.body.T31
 var T32=req.body.T32
 var T21=req.body.T21
